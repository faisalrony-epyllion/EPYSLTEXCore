...
{
    [Table(TableNames.YarnBookingChildItem_New)]
    public class YarnBookingChildItem : BaseChildItemMaster, IDapperBaseEntity//: DapperBaseEntity 
    {
        [ExplicitKey]
        ...
        [Write(false)]
        public List<BulkBookingDyedYarnUtilization> DyedYarnUtilizationPopUpList { get; set; } = new List<BulkBookingDyedYarnUtilization>();
        [Write(false)]
        ...
        [Write(false)]
        public decimal PrimaryNetYarnReqQty { get; set; }
        [Write(false)]
    ...
    public class YarnBookingChildYItem : YarnItemMaster//: DapperBaseEntity
    {
        [Write(false)]
        public int YBChildItemID { get; set; }
        [Write(false)]
        ...
        //[Write(false)] 
        //public new int ItemMasterID { get; set; }
        [Write(false)]
        public List<YarnItemPrice> yarnItemPrice { get; set; }
        [Write(false)]
        public List<YarnBookingChildItemYarnSubBrand> yarnBookingChildItemYarnSubBrand { get; set; }
