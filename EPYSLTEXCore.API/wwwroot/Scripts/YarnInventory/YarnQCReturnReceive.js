    ...
    function initRackLocation(list) {
        ...
        $tblRackLocationItemEl = new initEJ2Grid({
            ...
            columns: [
                ...
                { field: 'ReceiveQtyKg', headerText: 'Receive Qty (Kg)', allowEditing: true, width: 80, editType: "numericedit", params: { showSpinButton: false, decimals: 2, format: "N2", min: 0, validateDecimalOnType: true } }
            ],
            recordClick: function (args) {
