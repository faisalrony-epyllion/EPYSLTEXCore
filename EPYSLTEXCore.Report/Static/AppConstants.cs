 namespace EPYSLTEXCore.Report.Statics
{
    public static class AppConstants
    {
        ...
        public const string RND_FILE_PATH = "/Uploads/RND";
        public const string FIRM_CONCEPT_FILE_PATH = "/Uploads/FirmConcept";
        ...
        public const string UP_FILE_PATH = "/Uploads/UP";
        public const string ITEM_SUB_GROUP_FABRIC = "Fabric";
        public const int WASH_PROCESS_ID = 6;
        public const string NEW = "<<--New-->>";
        public const string GMT_ERP_BASE_PATH = "https://gmterp.epylliongroup.com";
        public const string BOOKING_FILTER_START_DATE = "1/1/2020";
        ...
        public const string FABRIC_CI_FILE_PATH = "/Uploads/FabricCI";
        public const string SCD_CONTACTS_DOC_TYPE_FILE_PATH = "/Uploads/SCD/ContactsDocType";
    }
    ...
    public static class EntityConfirmationStatus
    {
        public const int REWORK_FROM_KNITTING_PROGRAM = 1371;
        public const int RETRIAL_CONCEPT = 1372;
        public const int DROP_CONCEPT = 1373;
        public const int FUTURE_PRESERVATION = 1383;
    }
    ...
    public static class EntityTypeValueConstants
    {
        public const string RUNNING = "Running";
        public const string FIRM_CONCEPT = "Firm Concept";
        public const string LIVE_PRODUCT = "Live Product";
    ...
    public static class EntityEmployeeDepartment
    {
        public const string KNITTING = "Knitting";
    }

    public static class EntityEmployeeDesignation
    {
    ...
    public static class EntityTypeKnittingConfirmation
    {
        public const int Rework = 1094;
        public const int Gray_Fabric_OK = 1095;
    }
    ...
    {
        public const string ORDER_INFORMATION_PO = "8bb79d61-4f79-4403-9b1f-47c629e956a6";
        public const string BP_REPORT = "c2208612-f67b-40a8-ae8b-4b27d028fb94";
        public const string FABRIC_BOOKING_FOR_FG = "1575d941-d3b0-4cb4-a834-7d2641e2aaa9";
        public const string TTNA_CALENDER_DEP_WISE = "ed888b66-95a8-48ca-9768-e9e15d5a1127";
    }
    ...
    public static class ReportQueryFileNames
    {
        public const string TNA_BY_DATE_AND_EWO = "TNAByDateAndEWO.txt";
        public const string ORDER_INFORMATION = "OrderInformation.txt";
        public const string ORDER_INFORMATION_BP = "OrderInformationBP.txt";
        public const string YARN_REQUISITION_DETAILS_WITH_DATE_RANGE = "YarnRequisitionDetailsWithDateRange.txt";
        public const string YARN_REQUISITION_DETAILS_EWO_SERIES = "YarnRequisitionDetailsEWOSeries.txt";
    }
