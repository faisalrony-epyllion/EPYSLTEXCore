(function () {
    ...
    $(function () {
        ...
        /*
        //01-Oct-22
        $formEl.find("#YarnPRRequiredDate").click(function (e) {
            e.preventDefault();
            var PRDate = $formEl.find("#YarnPRDate").val();
            
            var RequiredDate = $formEl.find("#YarnPRRequiredDate").val();

            var date1 = new Date(PRDate);
            var date2 = new Date(RequiredDate);
            ...
            if (diffDays < 21) {
                ...
                //$formEl.find("#YarnPRRequiredDate").val(fDate);
                $formEl.find("#YarnPRRequiredDate").val(formatDateToDefault(fDate));
                //toastr.error("Required Date must be 21 days greater than Requisition Date");
                //masterData.YarnPRRequiredDate = $formEl.find("#YarnPRRequiredDate").val();
            }
    ...
    function isValidRequiredDate() {
        if (!isCPRPage) {
            ...
            if (diffDays < 1) {
                ...
                var fDate = formatDateToDefault(date);
                masterData.YarnPRRequiredDate = fDate;
                toastr.error("Required Date must be greater than requisition date.");
                return false;
            }
        }
        return true;
    ...
    function initMasterTable() {
        ...
        if (status == statusConstants.AWAITING_PROPOSE || status == statusConstants.ADDITIONAL) {
            ...
            columns = [
                {
                    ...
                    textAlign: 'Center', width: 120, minWidth: 120, maxWidth: 120
                },
                {
            ...
            columns = [
                {
                    headerText: '', textAlign: 'Center', commands: commands,
                    textAlign: 'Center', width: 140, minWidth: 140, maxWidth: 140
                },
                {
                    field: 'YarnPRFromID', visible: false
                },
