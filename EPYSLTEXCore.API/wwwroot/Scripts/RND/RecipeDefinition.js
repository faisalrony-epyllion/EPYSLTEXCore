(function () {
    ...
    $(function () {
        ...
        //// Get masterData from localStorage
        //if (localStorage.getItem('masterData') != null && (isAcknowledgePage == true || isApprovePage == true)) {
        //   masterData = JSON.parse(localStorage.getItem('masterData'));
        //}
        //else {
        //    localStorage.setItem('masterData', JSON.stringify(null));
        //}
