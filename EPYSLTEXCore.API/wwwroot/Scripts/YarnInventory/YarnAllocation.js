(function () {
    ...
    var $pageEl, $divTblEl, $divDetailsEl, $toolbarEl, $tblMasterEl, tblMasterId, $formEl,
    ...
    $(function () {
        ...
        if (menuParam == "YarnAllocation") _isYA = true;
    ...
    function initToolbars() {
       ...
       $modalGeryYarnUtilizationInfoEL.modal('hide');
        ...
        $formEl.find("#btnOk").click(function (e) {
            ...
            var msg = '';
            if (status != statusConstants.ACKNOWLEDGE && status != statusConstants.UN_ACKNOWLEDGE && status != statusConstants.REVISE) {
    ...
    function createYarnAllocation(row) {
        ...
        //var uniqueAry = distinctArrayByProperty(selectedRows, "CompanyId");
    ...
    async function addBooking() {
        var finder = new commonFinder({
            ...
            pageId: pageId,
            height: 320,
            apiEndPoint: `/api/yarn-allocation/GetPendingBooking`,
        ...
        if (_isYA) {
            ...
            for (var i = 0; i < data.Childs.length; i++) {
                ...
                if (data.Childs[i].AdvanceStockAllocationQty > 0 && data.Childs[i].ChildItems.length == 0) {
                    toastr.error(`Number of allocation popup item mismatch with allocation qty.`);
                    hasError = true;
                    break;
                }
                if (data.Childs[i].PipelineStockAllocationQty > 0 && data.Childs[i].ChildPipelineItems.length == 0) {
                    toastr.error(`Number of pipeline allocation popup item mismatch with pipeline allocation qty.`);
                    hasError = true;
                    break;
                }
