(function () {
    ...
    function initMasterTable_ForIndent() {
        ...
        var columns = [
            ...
            {
                field: 'IndentDate', headerText: 'Indent Date', textAlign: 'Center', type: 'date', format: 'dd/MM/yyyy', width: 100
            },
            ...
            {
                field: 'AcknowledgeDate', headerText: 'Commercial Ack Date', textAlign: 'Center', type: 'date', format: 'dd/MM/yyyy hh:mm:ss'//, visible: showAck, width: 100
            },
            {
                field: 'TexAcknowledgeDate', headerText: 'Acknowledge Date', textAlign: 'Center', type: 'date', format: 'dd/MM/yyyy hh:mm:ss'//, visible: showTexAck, width: 100
            }
        ];
    ...
    function initMasterTable() {
        ...
        var columns = [
            ...
            {
                field: 'CDAPRDate', headerText: 'PR Date', textAlign: 'Center', type: 'date', format: 'dd/MM/yyyy'
            },
            {
                field: 'TriggerPoint', headerText: 'Trigger Point'
            },
            {
                field: 'CDAPRRequiredDate', headerText: 'Required Date', textAlign: 'Center', type: 'date', format: 'dd/MM/yyyy'
            },
            {
