...
{
    [Table(TableNames.YD_RECIPE_DEFINITION_MASTER)]
    public class YDRecipeDefinitionMaster : DapperBaseEntity
    {
        public YDRecipeDefinitionMaster()
        {
            YDRecipeNo = AppConstants.NEW;
            RecipeDate = DateTime.Now;
            Childs = new List<YDRecipeDefinitionChild>();
            AllChilds = new List<YDRecipeDefinitionChild>();
            RecipeDefinitionItemInfos = new List<YDRecipeDefinitionItemInfo>();
            RecipeDefinitionDyeingInfos = new List<YDRecipeDefinitionDyeingInfo>();
            Temperature = 0;
            ProcessTime = 0;
            IsActive = true;
            Status = "";
        ...
        [Write(false)]
        public List<YDRecipeDefinitionChild> Childs { get; set; }
        [Write(false)]
        public List<YDRecipeDefinitionChild> AllChilds { get; set; }
        [Write(false)]
        public List<YDRecipeDefinitionItemInfo> RecipeDefinitionItemInfos { get; set; }
        [Write(false)]
        ...
        [Write(false)]
        public override bool IsModified => EntityState == System.Data.Entity.EntityState.Modified || YDRecipeID > 0;
        [Write(false)]
        public List<YDRecipeDefinitionDyeingInfo> RecipeDefinitionDyeingInfos { get; set; }
        [Write(false)]
