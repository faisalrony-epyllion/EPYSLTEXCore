...
{
    [Table("CDALoanReturnMaster")]
	public class CDALoanReturnMaster : DapperBaseEntity
	{
		...
		public string LReturnNo { get; set; }
		...
		[Write(false)]
		public List<CDALoanReturnChild> Childs { get; set; }
		[Write(false)]
		public List<CDALoanReturnChildAdjutment> ChildAdjutment { get; set; }

		[Write(false)]
		public override bool IsModified => EntityState == System.Data.Entity.EntityState.Modified || CDALRetuenMasterID > 0;
		...
		public CDALoanReturnMaster()
		{
			LReturnNo = AppConstants.NEW;
			LReturnDate = DateTime.Now;
			LocationID = 0;
			CompanyID = 0;
			...
			AddedBy = 0;
			UpdatedBy = 0;
			Childs = new List<CDALoanReturnChild>();
			ChildAdjutment = new List<CDALoanReturnChildAdjutment>();
		}
	}
