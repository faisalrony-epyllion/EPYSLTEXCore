    ...
    public class YarnPIReceiveService : IYarnPIReceiveService
    {
        ...
        public async Task<List<YarnPIReceiveMaster>> GetAsync(Status status, PaginationInfo paginationInfo)
        {
            ...
            if (status == Status.Pending)
            {
                sql = $@"
                    ...
                    YPM As ( 
	                    ...
	                    From {TableNames.YarnPOMaster} M
	                    Left Join {TableNames.YarnPIReceivePO} YPIPO ON M.YPOMasterID = YPIPO.YPOMasterID
                    ...
                    YPI AS(
	                    ...
	                    FROM {TableNames.YarnPOChild} YPC 
	                    INNER JOIN YPM ON YPM.YPOMasterID = YPC.YPOMasterID
                        Left Join {TableNames.YarnPIReceivePO} YPR ON YPR.YPOMasterID=YPC.YPOMasterID AND YPR.ItemMasterID=YPC.ItemMasterID And YPR.YPOChildID = YPC.YPOChildID
				    ...
				    RYPM as(
						...
						Left Join {TableNames.YarnPIReceivePO} YPO ON YPO.YPIReceiveMasterID = YPRM.YPIReceiveMasterID
						Left Join {TableNames.YarnPOMaster} M ON M.YPOMasterID = YPO.YPOMasterID
						...
						LEFT JOIN {TableNames.YarnPOChild} YPC ON YPC.YPOMasterID=M.YPOMasterID
                        Left JOIN {DbNames.EPYSL}..LoginUser LU ON LU.UserCode = M.AddedBy
	                ...
	                FROM FullFinal F
	                INNER JOIN {TableNames.YarnPIReceivePO} RPO ON RPO.YPIReceiveMasterID = F.YPIReceiveMasterID
	                INNER JOIN {TableNames.YarnPOMaster} POM ON POM.YPOMasterID = RPO.YPOMasterID 
					),
					PoIdList AS
					(
            ...
            else if (status == Status.RejectReview)
            {
                ...
                //     INNER JOIN {TableNames.YarnPOMaster} YPO ON YPIPO.YPOMasterID = YPO.YPOMasterID
            ...
            else if(status==Status.Revise)
            {
                ...
                (
	                ...
	                FROM TmpYR
	                INNER JOIN {TableNames.YarnPIReceivePO} RPO ON RPO.YPIReceiveMasterID = TmpYR.YPIReceiveMasterID
	                INNER JOIN {TableNames.YarnPOMaster} POM ON POM.YPOMasterID = RPO.YPOMasterID 
                ),
                PoIdList AS
                (
            ...
            else
            {
                ...
                (
	                ...
	                INNER JOIN YarnPIReceiveChild C ON C.YPIReceiveMasterID = M.YPIReceiveMasterID
	                INNER JOIN {DbNames.EPYSL}..Contacts CC ON CC.ContactID = M.SupplierID
					--INNER JOIN {TableNames.YarnPOMaster} YPO2 ON YPO2.YPOMasterID = M.YPOMasterID
	                INNER JOIN {TableNames.YarnPIReceivePO} YPIPO ON M.YPIReceiveMasterID = YPIPO.YPIReceiveMasterID
	                INNER JOIN {TableNames.YarnPOMaster} YPO ON YPO.YPOMasterID = YPIPO.YPOMasterID  
	                INNER JOIN {DbNames.EPYSL}..CompanyEntity CE ON CE.CompanyID = M.CompanyID
					LEFT JOIN RVSList RV ON RV.YPIReceiveMasterID = YPIPO.YPIReceiveMasterID
        ...
        public async Task<List<YarnPIReceiveMaster>> GetCDAAsync(Status status, PaginationInfo paginationInfo)
        {
            ...
            if (status == Status.Pending)
            {
                sql = $@"
                    ...
                    (
	                    ...
	                    Left Join {TableNames.YarnPIReceivePO} YPIPO ON CDAPM.CDAPOMasterID = YPIPO.YPOMasterID
            ...
            else if (status == Status.Reject)
            {
                sql = $@"
                    ;With M As 
                    (
                        Select * From {TableNames.YarnPIReceiveMaster} Where Reject = 1
                    )
                    ,YPI AS
                    (
        ...
        public async Task<YarnPIReceiveMaster> GetNewAsync(int yarnPoMasterId, int supplierId, int companyId)
        {
            var sql =
                ...
                ;With YPM AS(
	                ...
	                FROM {TableNames.YarnPOMaster} YPM
	                Left Join  {TableNames.YarnPIReceivePO} YPIPO ON YPIPO.YPOMasterID = YPM.YPOMasterID
                    Left Join {TableNames.YarnPIReceiveMaster} YPRM ON YPRM.YPIReceiveMasterID = YPIPO.YPIReceiveMasterID And YPRM.IsCDA = 0
                ...
                -- Childs
                ;With YPC As (
	                Select * From {TableNames.YarnPOChild} Where YPOMasterID = {yarnPoMasterId}
                ),
                Finalist As(
                ...
                FROM YPC 
                Inner Join {TableNames.YarnPOMaster} YPOM ON YPC.YPOMasterID = YPOM.YPOMasterID
                LEFT JOIN {TableNames.YarnPIReceivePO} B ON YPC.YPOMasterID=B.YPOMasterID  And YPC.YPOChildID = B.YPOChildID --and YPC.ItemMasterID=B.ItemMasterID
                ...
                -- {TableNames.YarnPIReceivePO}
                ;With A As 
                (
	                Select B.YPOMasterID, B.ItemMasterID, Sum(B.PIQty) PIQty
	                From {TableNames.YarnPIReceivePO} B
                    Inner Join {TableNames.YarnPIReceiveMaster} YPRM ON YPRM.YPIReceiveMasterID = B.YPIReceiveMasterID And YPRM.IsCDA = 0
        ...
        public async Task<YarnPIReceiveMaster> GetNewCDAAsync(int yarnPoMasterId, int supplierId, int companyId)
        {
            var sql =
                ...
                (
                    ...
                    Left Join {TableNames.YarnPIReceivePO} YPIPO ON YPIPO.YPOMasterID = CPM.CDAPOMasterID
                    Left Join {TableNames.YarnPIReceiveMaster} YPRM ON YPRM.YPIReceiveMasterID = YPIPO.YPIReceiveMasterID And YPRM.IsCDA = 1
                ...
                (
	                Select B.YPOMasterID, B.ItemMasterID, Sum(B.PIQty) PIQty
	                From {TableNames.YarnPIReceivePO} B
                    Inner Join {TableNames.YarnPIReceiveMaster} YPRM ON YPRM.YPIReceiveMasterID = B.YPIReceiveMasterID And YPRM.IsCDA = 1
	                Where B.YPOMasterID in ({yarnPoMasterId})
	                Group By B.YPOMasterID, B.ItemMasterID
                ), B As 
                (
        ...
        public async Task<List<AvailablePOForPI>> GetAvailablePOForPIAsync(int[] poMasterIdArray, int supplierId, int companyId, int yPIReceiveMasterID)
        {
            ...
            (
	            ...
	            From {TableNames.YarnPOMaster} M
	            Inner Join {TableNames.YarnPOChild} C ON C.YPOMasterID = M.YPOMasterID
	            Inner Join {DbNames.EPYSL}..CompanyEntity CE ON M.CompanyID = CE.CompanyID
	            Left Join {TableNames.YarnPIReceivePO} YPIPO ON M.YPOMasterID = YPIPO.YPOMasterID And YPIPO.ItemMasterID = C.ItemMasterID
        ...
        public async Task<List<AvailablePOForPI>> GetAvailableCDAPOForPIAsync(int[] poMasterIdArray, int supplierId, int companyId, int yPIReceiveMasterID)
        {
            ...
            (
	            ...
	            Inner Join {DbNames.EPYSL}..CompanyEntity CE ON M.CompanyID = CE.CompanyID
	            Left Join {TableNames.YarnPIReceivePO} YPIPO ON M.CDAPOMasterID = YPIPO.YPOMasterID 
        ...
        public async Task<YarnPIReceiveMaster> GetAsync(int id, int supplierId, int companyId, bool isYarnReceivePage)
        {
            ...
            if(isYarnReceivePage)
            {
                ...
                FROM YPC
                --Left Join {TableNames.YarnPIReceivePO} YPO ON YPO.YPIReceiveMasterID = YPC.YPIReceiveMasterID And YPO.ItemMasterID = YPC.ItemMasterID 
				--Left Join {TableNames.YarnPOChild} YPOC ON YPOC.YPOMasterID = YPO.YPOMasterID And YPOC.ItemMasterID = YPO.ItemMasterID
                ...
                From PO
                Inner Join {TableNames.YarnPOMaster} POM On POM.YPOMasterID = PO.YPOMasterID
                Inner Join {TableNames.YarnPOChild} POC On POC.YPOMasterID = PO.YPOMasterID
                ...
                (
	                Select B.YPOMasterID, B.ItemMasterID, Sum(B.PIQty) PIQty
	                From {TableNames.YarnPIReceivePO} B
	                Where B.YPOMasterID IN(Select YPOMasterID From {TableNames.YarnPIReceiveMaster} Where YPIReceiveMasterID = {id})
                ...
                (
	                ...
	                From {TableNames.YarnPOChild}
	                Where YPOMasterID IN(Select YPOMasterID From {TableNames.YarnPIReceiveMaster} Where YPIReceiveMasterID = {id})
                ...
                Inner Join {TableNames.YarnPOMaster} YPO on YPO.YPOMasterID=B.YPOMasterID
        ...
        public async Task<YarnPIReceiveMaster> GetReviceAsync(int id, int supplierId, int companyId, bool isYarnReceivePage, string poIds)
        {
            ...
            if (isYarnReceivePage)
            {
                ...
                */
                ...
                LEFT JOIN  {DbNames.EPYSL}..CompanyEntity CE ON CE.CompanyID = M.CompanyID
                LEFT JOIN  {DbNames.EPYSL}..Contacts C ON C.ContactID = M.SupplierID
                LEFT JOIN {TableNames.YarnPIReceivePO} YPIPO ON M.YPIReceiveMasterID = YPIPO.YPIReceiveMasterID
	            LEFT JOIN {TableNames.YarnPOMaster} YPO ON YPO.YPOMasterID = YPIPO.YPOMasterID;
                ...
                (
                    ...
                    LEFT JOIN {TableNames.YarnPIReceivePO} YPO ON  YPO.YPOChildID = POC.YPOChildID --AND YPO.ItemMasterID = POC.ItemMasterID
				...
				(
					...
					INNER JOIN {TableNames.YarnPIReceivePO} RPO ON RPO.YPIReceiveMasterID = RC.YPIReceiveMasterID AND RPO.ItemMasterID = RC.ItemMasterID
					INNER JOIN {TableNames.YarnPOChild} YPOC ON YPOC.YPOMasterID = RPO.YPOMasterID AND YPOC.YPOChildID = RPO.YPOChildID --AND YPOC.ItemMasterID = RPO.ItemMasterID
        ...
        public async Task<YarnPIReceiveMaster> GetYarnPIReceiveChildItemsAsync(string ypoMasterIds, int yPIReceiveMasterID)
        {
            ...
            FROM {TableNames.YarnPOMaster} YPOM
            INNER JOIN {TableNames.YarnPOChild} YPC ON YPC.YPOMasterID = YPOM.YPOMasterID
            INNER JOIN {DbNames.EPYSL}..Contacts C ON C.ContactID = YPOM.SupplierID
            LEFT JOIN {DbNames.EPYSL}..ItemMaster IM ON IM.ItemMasterID = YPC.ItemMasterID
            LEFT JOIN {DbNames.EPYSL}..ItemSegmentValue ISV1 On ISV1.SegmentValueID = IM.Segment1ValueID
            LEFT JOIN {DbNames.EPYSL}..ItemSegmentValue ISV2 ON ISV2.SegmentValueID = IM.Segment2ValueID
            ...
            INNER JOIN {DbNames.EPYSL}..Unit U ON U.UnitID = YPC.UnitID
            --------------------------------------
            Left Join {TableNames.YarnPIReceivePO} YRP On YRP.YPOMasterID = YPOM.YPOMasterID And YRP.ItemMasterID = YPC.ItemMasterID And YRP.YPIReceiveMasterID != {yPIReceiveMasterID}
            ...
            Left Join {TableNames.YarnPIReceiveMaster} YPRM ON YPRM.YPIReceiveMasterID = YRP.YPIReceiveMasterID And YPRM.IsCDA = 0
        ...
        public async Task<YarnPIReceiveMaster> GetCDAPIReceiveChildItemsAsync(string ypoMasterIds, int yPIReceiveMasterID)
        {
            ...
            INNER JOIN {DbNames.EPYSL}..Unit U ON U.UnitID = YPC.UnitID
            --------------------------------------
            Left Join {TableNames.YarnPIReceivePO} YRP On YRP.YPOMasterID = YPOM.CDAPOMasterID And YRP.ItemMasterID = YPC.ItemMasterID And YRP.YPIReceiveMasterID != {yPIReceiveMasterID}
            ...
            Left Join {TableNames.YarnPIReceiveMaster} YPRM ON YPRM.YPIReceiveMasterID = YRP.YPIReceiveMasterID And Isnull(YPRM.IsCDA,0) = 1
        ...
        public async Task<YarnPIReceiveMaster> GetAllByIDAsync(int id)
        {
            ...
            ;Select * From {TableNames.YarnPIReceivePO} Where YPIReceiveMasterID = {id}

            ;select YPM.RevisionNo 
            From {TableNames.YarnPIReceivePO} YPRP
            Inner Join {TableNames.YarnPOMaster} YPM ON YPM.YPOMasterID=YPRP.YPOMasterID
            Where YPM.YPOMasterID=(Select Top 1 YPOMasterID From {TableNames.YarnPIReceivePO} Where YPIReceiveMasterID = {id})

            ;Select YPC.* 
			From {TableNames.YarnPOChild} YPC
			Inner Join {TableNames.YarnPIReceivePO} YPIPO ON YPIPO.YPOMasterID = YPC.YPOMasterID
        ...
        public async Task<List<YarnPIReceiveMaster>> GetAsync(Status status, PaginationInfo paginationInfo, string LcNo)
        {
            ...
            if (status == Status.Pending)
            {
                sql = $@"
                    ...
                    YPI AS(
                        ...
                        --FROM YPM 
                        --INNER JOIN {TableNames.YarnPOChild} YPC ON YPC.YPOMasterID = YPM.YPOMasterID
                        --LEFT JOIN YarnPIFor YPF ON YPF.POForID = YPM.POForID
	                    ...
	                    FROM {TableNames.YarnPOChild} YPC 
	                    INNER JOIN YPM ON YPM.YPOMasterID = YPC.YPOMasterID
                        Left Join {TableNames.YarnPIReceivePO} YPR ON YPR.YPOMasterID=YPC.YPOMasterID AND YPR.ItemMasterID=YPC.ItemMasterID
						--Left Join YarnPIReceiveChild YPRC ON YPRC.ItemMasterID=YPC.ItemMasterID and YPRC.YPIReceiveMasterID=YPR.YPIReceiveMasterID
	                    LEFT JOIN YarnPIFor YPF ON YPF.POForID = YPM.POForID
	                    Inner Join {DbNames.EPYSL}..Contacts ON Contacts.ContactID = YPM.SupplierID
	                    INNER JOIN {DbNames.EPYSL}..CompanyEntity CE ON CE.CompanyID = YPM.CompanyID
            ...
            else
            {
                ...
                (
	                ...
	                C.YPIReceiveChildID, C.POQty, C.Rate, C.PIQty, C.PIValue   
                    FROM LCPI
					Inner Join {TableNames.YarnPIReceiveMaster} M On M.YPIReceiveMasterID = LCPI.YPIReceiveMasterID
	                INNER JOIN YarnPIReceiveChild C ON C.YPIReceiveMasterID = M.YPIReceiveMasterID
	                INNER JOIN {DbNames.EPYSL}..Contacts CC ON CC.ContactID = M.SupplierID
	                INNER JOIN {TableNames.YarnPIReceivePO} YPIPO ON M.YPIReceiveMasterID = YPIPO.YPIReceiveMasterID
	                INNER JOIN {TableNames.YarnPOMaster} YPO ON YPO.YPOMasterID = YPIPO.YPOMasterID  
        ...
        {
            string sql = $@"
            ;Select * From {TableNames.YarnPIReceivePO} Where YPOMasterID = {id}";
