...
function generateMenu(menuList) {
    $.each(menuList, function (i, item) {
        if (!item.Childs.length) {
            template += '<li><a href="#!" data-report-id="' + item.ReportId + '" data-has-external-report="' + item.HasExternalReport + '"><i class="fa fa-circle-o"></i><span title="' + item.Node_Text + '">' + item.Node_Text + '</span></a></li>';
            activeMenu = false;
            return true;
        }
        else {
