(function () {
    ...
    $(function () {
        ...
        $("#btnRejectYPO").click(function (e) {
            ...
            bootbox.prompt("Are you sure you want to unacknowledge this?", function (result) {
                ...
                axios.post("/api/yarn-purchase-requisition/unacknowledge", data)
                    .then(function () {
                        toastr.warning('Unacknowledge sucessfully!');
                        l.ladda('stop');
                        backToList();
                    })
    ...
    function initMasterTable() {
        ...
        $tblMasterEl.bootstrapTable({
            ...
            columns: [
                ...
                {
                    field: "YpUnAcknowledgeBy",
                    title: "UnAcknowledge By",
                    filterControl: "input",
                    filterControlPlaceholder: FILTERCONTROLPLACEHOLDER,
                    visible: status == statusConstants.UN_ACKNOWLEDGE
                },
                {
                    field: "Remarks",
                    title: "Remarks",
    ...
    function Approve() {
        ...
        data["Childs"] = YPRequisition.Childs;
        console.log(YPRequisition.Childs);
        axios.post("/api/yarn-purchase-requisition/Acknowledge", data)
            .then(function () {
