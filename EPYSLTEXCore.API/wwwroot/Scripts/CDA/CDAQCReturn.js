(function () {
            ...
            columns: [
                {
                    ...
                    formatter: function (value, row, index, field) {
                        ...
                        if (status === statusConstants.PENDING) {
                            template =
                                `<a class="btn btn-xs btn-default add" href="javascript:void(0)" title="New CDA QC Retrurn">
                    ...
                    events: {
                        'click .add': function (e, value, row, index) {
                            ...
                            getNew(row.QCRemarksMasterID);
                        },
                        'click .edit': function (e, value, row, index) {
                            e.preventDefault();
                            getDetails(row.QCReturnMasterID);
                        }
                    }
                },
                {
    ...
    function getMasterTableData() {
        ...
        var url = `/api/CDA-qc-return/list?gridType=bootstrap-table&status=${status}&${queryParams}`;
        axios.get(url)
    ...
    function getNew(reqMasterId) {
        axios.get(`/api/CDA-qc-return/new/${reqMasterId}`)
            .then(function (response) {
                $divDetailsEl.fadeIn();
                $divTblEl.fadeOut();
    ...
    function getDetails(id) {
        axios.get(`/api/CDA-qc-return/${id}`)
            .then(function (response) {
                $divDetailsEl.fadeIn();
                $divTblEl.fadeOut();
                CDAQCReq = response.data;
    ...
    function save() {
        ...
        axios.post("/api/CDA-qc-return/save", data)
            .then(function () {
