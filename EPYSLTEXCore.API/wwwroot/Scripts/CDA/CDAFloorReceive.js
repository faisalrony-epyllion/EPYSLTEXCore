(function () {
    ...
    //Id			FloorReceivedByUser	FloorIssueMasterID	FloorIssueNo	FloorIssueDate	FloorIssueByUser	FloorReqNo	FloorReqDate	FloorReqFor	ReqQtyCone	IssueQtyCone	IssueQtyCarton	ReceiveQtyCarton	TotalRows
    ...
    function getMasterTableData() {
        ...
        var url = `/api/CDA-Floor-receive/list?gridType=bootstrap-table&status=${status}&${queryParams}`;
        axios.get(url)
    ...
    function getNew(FloorIssueMasterId) {
        axios.get(`/api/CDA-Floor-receive/new/${FloorIssueMasterId}`)
            .then(function (response) {
                $divDetailsEl.fadeIn();
                $divTblEl.fadeOut();
                ...
                CDAFloorReceive.FloorIssueDate = formatDateToDefault(CDAFloorReceive.FloorIssueDate);
    ...
    function getDetails(id) {
        axios.get(`/api/CDA-Floor-receive/${id}`)
            .then(function (response) {
                $divDetailsEl.fadeIn();
                $divTblEl.fadeOut();
                CDAFloorReceive = response.data;
    ...
    function save(e) {
        ...
        data["Childs"] = CDAFloorReceive.Childs;
        axios.post("/api/CDA-Floor-receive/save", data)
            .then(function () {
