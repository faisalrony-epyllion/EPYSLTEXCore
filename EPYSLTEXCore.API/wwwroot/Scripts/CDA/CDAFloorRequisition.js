(function () {
    ...
    $(function () {
        ...
        if (isAcknowledgePage) {
            ...
            $toolbarEl.find("#btnPendingBatch").hide();
        ...
        $toolbarEl.find("#btnPendingBatch").on("click", function (e) {
            e.preventDefault();
            toggleActiveToolbarBtn(this, $toolbarEl);
            resetTableParams();
            status = statusConstants.PENDING_BATCH;
            initMasterTable();
            getMasterTableData();
        });
        ...
        $formEl.find("#btnNewItem").on("click", function (e) {
            e.preventDefault();
            var newChildItem = {
                Id: getMaxIdForArray(CDAFloorRequisition.Childs, "Id"),
                CDAReqMasterId: 0,
                ReqQty: 0,
                Remarks: "",
                SubGroupId: 0,
            ...
            CDAFloorRequisition.Childs.push(newChildItem);
        ...
        $formEl.find("#btnApproveYPO").click(function (e) {
            ...
            axios.post(`/api/CDA-Floor-requisition/approve/${id}`)
                .then(function () {
        ...
        $formEl.find("#btnAcknowledge").click(function (e) {
            e.preventDefault();
            var id = $formEl.find("#Id").val();
            axios.post(`/api/CDA-Floor-requisition/acknowledge/${id}`)
                .then(function () {
        ...
        $formEl.find("#btnRejectYPO").click(function (e) {
            ...
            bootbox.prompt("Are you sure you want to reject this?", function (result) {
                ...
                var id = $formEl.find("#Id").val();
                var reason = result;
                axios.post(`/api/CDA-Floor-requisition/reject/${id}/${reason}`)
                    .then(function () {
        ...
        $tblMasterEl.bootstrapTable({
            ...
            columns: [
                ...
                },
                {
                    ...
                    formatter: function (value, row, index, field) {
                        return [
                            '<a class="btn btn-xs btn-default edit" href="javascript:void(0)" title="New Requisition">',
    ...
    function getMasterTableData() {
        ...
        var url = "/api/CDA-Floor-requisition/list?gridType=bootstrap-table&status=" + status + "&" + queryParams;
        axios.get(url)
            ...
            columns: [
                ...
                },
                {
                    ...
                    editable: {
                        ...
                        inputclass: 'input-sm',
                        showbuttons: false,
                        source: CDAFloorRequisition.ItemList,
                ...
                },
                {
                    ...
                    editable: {
                        ...
                        inputclass: 'input-sm',
                        showbuttons: false,
                        source: CDAFloorRequisition.AgentList,
    ...
    function getNew(subgroupId) {
        var url = "/api/CDA-Floor-requisition/new/" + subgroupId;
        axios.get(url)
            .then(function (response) {
                $divDetailsEl.fadeIn();
                $divTblEl.fadeOut();
    ...
    function getDetails(id) {
        axios.get(`/api/CDA-Floor-requisition/${id}`)
            .then(function (response) {
                $divDetailsEl.fadeIn();
                $divTblEl.fadeOut();
                CDAFloorRequisition = response.data;
                ...
                if (!CDAFloorRequisition.IsApprove && !CDAFloorRequisition.Reject) {
                    isEditable = false;
                    ...
                    if (isApprovePage && !CDAFloorRequisition.IsApprove && !CDAFloorRequisition.Reject) {
                    ...
                    if (isAcknowledgePage && CDAFloorRequisition.IsApprove && !CDAFloorRequisition.IsAcknowledge) {
                ...
                else if (CDAFloorRequisition.IsApprove || CDAFloorRequisition.Reject) {
                    $formEl.find("#btnSave").hide();
                    $formEl.find("#btnNewItem").hide();
                    $formEl.find("#CompanyID").prop("disabled", true);
                    $formEl.find("#CDARequisitionBy").prop("disabled", true);
    ...
    function getNewPendingBatch(id) {
        axios.get(`/api/CDA-Floor-requisition/newPendingBatch/${id}`)
            .then(function (response) {
                $divDetailsEl.fadeIn();
                $divTblEl.fadeOut();
                CDAFloorRequisition = response.data;
    ...
    function save() {
        ...
        axios.post("/api/CDA-Floor-requisition/save", data)
            .then(function () {
