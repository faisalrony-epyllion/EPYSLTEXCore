...
namespace EPYSLTEXCore.API.Contollers.Inventory.Yarn
{
    ...
    public class YDRecipeRequestesController : ApiBaseController
    {
        ...
        public YDRecipeRequestesController(IUserService userService, IYDRecipeRequestService service, ICommonHelperService commonService, IYDRecipeDefinitionService serviceRecipeDefinition) : base(userService)
        {
            _service = service;
