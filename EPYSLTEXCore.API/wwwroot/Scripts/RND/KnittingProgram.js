(function () {
    ...
    function initMasterTable() {
        ...
        var columns = [
            ...
            {
                field: 'Buyer', headerText: 'Buyer', width: 100, headerTextAlign: 'Center', visible: (isBDSPage || isBulkPage)
            },
            {
                field: 'BuyerTeam', headerText: 'Buyer Team', width: 100, headerTextAlign: 'Center', visible: (isBDSPage || isBulkPage)
            },
            {
            ...
            {
                field: 'Size', headerText: 'Size', width: 40, visible: !isConceptPage
            },
            {
                field: 'Qty', headerText: 'QTY', width: 40, textAlign: 'Center', headerTextAlign: 'Center', visible: isConceptPage
            },
            {
                field: 'TotalQty', headerText: 'Plan Qty', width: 40, textAlign: 'Center', headerTextAlign: 'Center', visible: isConceptPage
            },
            {
                field: 'RemainingQty', headerText: 'Remaining Qty', width: 52, textAlign: 'Center', headerTextAlign: 'Center', visible: isConceptPage
            },
            {
                field: 'Active', headerText: 'Active?', visible: status == statusConstants.ALL, width: 44, textAlign: 'Center', headerTextAlign: 'Center'
            },
            {
                field: 'UserName', headerText: 'Concept By', width: 60, visible: isConceptPage
            }
        ];
    ...
    function getDetails(id, subgroupName) {
        ...
        if (isBDSPage) type = knittingProgramType.BDS;
