...
(function () {
    ...
    function initMasterTable() {
        var columns = [
            {
                headerText: 'Command', width: ch_setActionCommandCellWidth_N(3), textAlign: 'Left', visible: status == statusConstants.ACTIVE, commands: [
            ...
            {
                headerText: 'Command', width: ch_setActionCommandCellWidth_N(3), textAlign: 'Left', visible: (status == statusConstants.COMPLETED || status == statusConstants.UN_ACKNOWLEDGE || status == statusConstants.OTHERS), commands: [
                    { type: 'View', title: 'View', buttonOption: { cssClass: 'e-flat', iconCss: 'fa fa-eye' } },
                    { type: 'Booking Report', buttonOption: { cssClass: 'e-flat', iconCss: 'e-pdf e-icons' } },
                    { type: 'View Attachment', buttonOption: { cssClass: 'e-flat', iconCss: 'e-image e-icons' } }
                ]
            ...
            {
                headerText: 'Command', width: ch_setActionCommandCellWidth_N(3), textAlign: 'Left', visible: (status == statusConstants.APPROVED), commands: [
