...
namespace EPYSLTEXCore.API.Contollers.Inventory.Yarn
{
    ...
    public class YarnQCRequisitionController : ApiBaseController
    {
        ...
        public YarnQCRequisitionController(IYarnQCReqService service, IYarnReceiveService serviceYR, IYarnQCRemarksService serviceQCRemarks)
        {
            _service = service;
        ...
        public async Task<IHttpActionResult> GetReceiveData(int receiveId)
        {
        ...
        [HttpGet]
        public async Task<IHttpActionResult> Get(int id, Status status, int itemMasterID)
        {
        ...
        [HttpGet]
        public async Task<IHttpActionResult> GetByRemarksChildId(int id, int qcRemarksChildID)
        {
        ...
        [HttpGet]
        public async Task<IHttpActionResult> GetByReceiveChildIds(string receiveChildIds)
        {
        ...
        [HttpGet]
        public async Task<IHttpActionResult> GetRetest(int qcReqMasterID)
        {
        ...
        [HttpPost]
        [ValidateModel]
        public async Task<IHttpActionResult> Save(YarnQCReqMaster model)
        {
