(function () {
        ...
        $formEl.find("#btnAddBatch").on("click", function (e) {
            ...
            var finder = new commonFinder({
                ...
                onSelect: function (selectedRecord) {
                    ...
                    axios.get(`/api/dyeing-batch/${selectedRecord.rowData.YDDBatchID}`)
    ...
    function handleCommands(args) {
        if (args.commandColumn.type == 'Add') {
            ...
            getNew(args.rowData.CCColorID, args.rowData.GroupConceptNo, args.rowData.IsBDS, args.rowData.RecipeReqNo, args.rowData.YDDBatchID);
        }
    ...
    function getNew(ccColorId, grpConceptNo, isBDS, isRework, recipeReqNo, YDDBatchID) {
        recipeCopy == false;
        masterData = {};
        var url = `/api/yd-recipe-request/new/${ccColorId}/${grpConceptNo}/${isBDS}/${isRework}/${recipeReqNo}/${YDDBatchID}`;
        axios.get(url)
            .then(function (response) {
                $divDetailsEl.fadeIn();
                $divTblEl.fadeOut();
    ...
    function createNew() {
        ...
        getNew(selectedRecords[0].CCColorID, selectedRecords[0].GroupConceptNo, selectedRecords[0].IsBDS, isRework, recipeReqNo, selectedRecords[0].YDDBatchID);
    }
})();