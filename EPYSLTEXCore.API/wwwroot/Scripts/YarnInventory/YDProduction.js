(function () {
    ...
    $(function () {
        ...
        YDProductionApprovePage = convertToBoolean($(`#${pageId}`).find("#YDProductionApprovePage").val());
        YDProductionAcknowledgePage = convertToBoolean($(`#${pageId}`).find("#YDProductionAcknowledgePage").val());
    ...
    function handleCommands(args) {
        if (status === statusConstants.PENDING) {
            getNew(args.rowData.YDBookingMasterID, args.rowData.ItemMasterID, args.rowData.ColorID);
    ...
    function initChildTable(records) {
        ...
        var columns = [{ field: 'ItemMasterID', isPrimaryKey: true, visible: false }];
    ...
    function getNew(newId, itemMasterID, colorID) {
        axios.get(`/api/yarn-production/new/${newId}/${itemMasterID}/${colorID}`)
