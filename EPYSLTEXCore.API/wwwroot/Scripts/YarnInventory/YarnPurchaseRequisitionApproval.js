(function () {
    ...
    $(function () {
        ...
        $("#btnRejectYPO").click(function (e) {
            ...
            bootbox.prompt("Are you sure you want to reject this?", function (result) {
                ...
                axios.post("/api/yarn-purchase-requisition/Reject", data)
                    .then(function () {
            ...
            columns: [
                {
                    ...
                    visible: status == statusConstants.PROPOSED
                },
                {
                    field: "YpReqNo",
                ...
                },
                {
                    ...
                    filterControl: "input",
                    filterControlPlaceholder: FILTERCONTROLPLACEHOLDER,
                    visible: status == statusConstants.REJECT
                },
    ...
    function Approve() {
        ...
        data["Childs"] = YPRequisition.Childs;
        console.log(YPRequisition.Childs);
        axios.post("/api/yarn-purchase-requisition/Approve", data)
            .then(function () {
