(function () { 
    ...
    function initMasterTable() { 
        var columns = [
            ...
            {
                field: 'LReceiveDate', headerText: 'Receive Date', textAlign: 'Center', type: 'date', format: 'dd/MM/yyyy'
            },
            {
                field: 'ChallanNo', headerText: 'Challan No'
            },
            {
                field: 'ChallanDate', headerText: 'Challan Date', textAlign: 'Center', type: 'date', format: 'dd/MM/yyyy'
            },
            {
    ...
    async function initChildTable(data) {
        ...
        var columns = [];
        columns = await getYarnItemColumnsAsync(isEditable);
        ...
        var additionalColumns = [
            ...
            { field: 'Rate', headerText: 'Rate', editType: "numericedit", edit: { params: { decimals: 0 } } },
            { field: 'ChallanQty', headerText: 'Challan Qty(kg)', editType: "numericedit", edit: { params: { decimals: 0 } } },
            { field: 'ReceiveQty', headerText: 'Receive Qty(Kg)', editType: "numericedit", edit: { params: { decimals: 0 } } },
            { field: 'ChallanQtyCone', headerText: 'Challan Qty(Cone)', editType: "numericedit", edit: { params: { decimals: 0 } } },
            { field: 'ReceiveQtyCone', headerText: 'Receive Qty(Cone)', editType: "numericedit", edit: { params: { decimals: 0 } } },
            { field: 'ChallanQtyCarton', headerText: 'Challan Qty(Crtn)', editType: "numericedit", edit: { params: { decimals: 0 } } },
            { field: 'ReceiveQtyCarton', headerText: 'Receive Qty(Crtn)', editType: "numericedit", edit: { params: { decimals: 0 } } },
